<?php
    ...
    if($extension != "csv"){
        ...
        while(($data = fgetcsv($object, 1000, ",")) !== FALSE)
        {
            ...
            $cli_clientes_codcliente    = mb_convert_encoding($data[2], "utf-8"); // pega o id do cliente
            $cli_enderecos_codendereco  = mb_convert_encoding($data[0], "utf-8"); // pega o codendereco
