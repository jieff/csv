<?php require './src/includes/header.html'; ?>
    ...
    <header class="pb-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-filetype-csv" viewBox="0 0 16 16">
        ...
        <div class="p-5 mb-4 bg-light rounded-3 ">
            <div class="col-md-8">
                <div class="h-100 p-5 text-white bg-dark rounded-3">
                        ...
                        <form  method="POST" action="./src/ativo.php" enctype="multipart/form-data">
        ...
        <div class="p-5 mb-4 bg-light rounded-3 ">
            ...
            1 - cli_clientes
            2 - cli_enderecos * obs:cidade e estado
            3 - cli_celulares
            4 - cli_emails
            5 - contas_acesso ( campo situacao tabela cli_clientes, refere-se ao status do cliente no sistema) 
            ______________

            6 - cli_celulares_trim (formata os numeros) 
            7 - cli_email_trim     (formata os e-mails)
            ______________

            8 - campo centralassinantestatus ([valor]=31, seta alterar senha,
                                             consultar extrato, consultar cobrancas,
                                             permitir gerar 2 cobranca, gerenciar emails)

            ________________

            9 - ativo (Nova Lista de clientes Ativos) tabela: cli_clientes
